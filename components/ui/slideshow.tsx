...
export const DEFAULT_SLIDES: SlideItem[] = [
  {
    id: 1,
    img: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=2400&q=85',
    fallbackImg: 'https://cdn.cosmos.so/8b0252bd-cb64-45f4-aef8-672c7f628f76?format=jpeg',
    tag: 'The Core Vision & Welcome',
    text: ['WELCOME TO', 'CLOUDFEN'],
    subtitle: 'Your Vision is Our Mission. We are reliable, strong in support services, and lead the growing technology.',
    primaryCta: {
      text: 'Discover CloudFen',
      href: '#about-us',
      action: 'link',
    },
    secondaryCta: {
  ...
  },
  {
    ...
    tag: 'The Mission & Brand Promise',
    text: ['REDEFINING', 'YOUR BRAND'],
    subtitle: 'We establish interactive platforms to achieve your goals. With healthy infrastructure and advanced software product development, we offer updated application servers.',
    primaryCta: {
  ...
  },
  {
    ...
    tag: 'Core Services Overview',
    text: ['VERSATILE SOFTWARE', 'SOLUTIONS'],
    subtitle: 'From IT Staffing and Product Development to Recruitment and Outsourcing—we make real things happen for our customers through high-quality services.',
    primaryCta: {
  ...
  },
  {
    ...
    tag: 'Performance & Creation',
    text: ['GREAT PERFORMANCE,', 'PERFECT RESULTS'],
    subtitle: "Create just what you need for your perfect website. You'll be surprised to see the final results of your creation and crave for more.",
    primaryCta: {
      text: 'Launch Console',
      action: 'demo',
    },
  ...
  },
  {
    ...
    tag: 'Infrastructure & Call to Action',
    text: ['UPGRADE YOUR', 'INFRASTRUCTURE'],
    subtitle: 'Assessing or upgrading your network systems? Moving legacy systems to Cloud technology? We have the highly skilled engineers to get it done.',
    primaryCta: {
      text: 'Contact Us',
      href: '/contact',
      action: 'link',
